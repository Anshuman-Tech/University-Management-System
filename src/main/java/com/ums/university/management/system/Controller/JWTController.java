...
import com.ums.university.management.system.Service.Impl.CustomUserDetails;
...
public class JWTController {
    ...
    @PostMapping("/token")
    public ResponseEntity<?> generateToken(JWTRequestDTO jwtRequest) throws Exception {
        try{
        ...
        //generate token
        CustomUserDetails customUserDetails = (CustomUserDetails) this.customUserDetailsServiceImpl.loadUserByUsername(jwtRequest.getEmailId());
        String token = this.jwtUtil.generateToken(customUserDetails);
